package ru.vladalexeco.playlistmaker.medialibrary.ui.adapters
...
class LibraryTrackAdapter(val clickListener: TrackClickListener): RecyclerView.Adapter<LibraryTrackAdapter.TrackHolder>() {
